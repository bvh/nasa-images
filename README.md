...
uv run nasa.py fetch search [--q TEXT] [--center TEXT] [--description TEXT] \
  [--description-508 TEXT] [--keywords TEXT] [--location TEXT] \
  [--media-type image|video|audio] [--nasa-id TEXT] [--page-size INT] \
  [--photographer TEXT] [--secondary-creator TEXT] \
...
uv run nasa.py fetch search --q "Apollo 11" --media-type image --year-start 1969 --year-end 1969 --catalog /tmp/nasa-cat
```
